namespace harj_8
{
    public partial class Form1 : Form
    {
        ...
        private void muutaBT_Click(object sender, EventArgs e)
        {
            ...
            {
                luku1 = Convert.ToInt32(textbox.Text.Substring(0, 1));
                luku2 = Convert.ToInt32(textbox.Text.Substring(1, 1));
                luku3 = Convert.ToInt32(textbox.Text.Substring(2, 1));
                luku4 = Convert.ToInt32(textbox.Text.Substring(3, 1));
                if(luku1 % 3 == 0) 
                {
                    vastaus += "MMM";
                }
            ...
            {
                luku2 = Convert.ToInt32(textbox.Text.Substring(0, 1));
                luku3 = Convert.ToInt32(textbox.Text.Substring(1, 1));
                luku4 = Convert.ToInt32(textbox.Text.Substring(2, 1));
                vastaus += sataset(luku2, vastaus);
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
            }
            ...
            {
                luku3 = Convert.ToInt32(textbox.Text.Substring(0, 1));
                luku4 = Convert.ToInt32(textbox.Text.Substring(1, 1));
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
            }
            else if (textbox.Text.Length > 0)
            {
                luku4 = Convert.ToInt32(textbox.Text.Substring(0, 1));
                vastaus += ykkoset(luku4, vastaus);
            }
